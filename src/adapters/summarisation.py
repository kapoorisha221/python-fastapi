...
class Summarization():
    ...
    def __init__(self):       
        ...
        self.document = []
        self.text_to_append = ""
        self.ENDPOINT = self.cred.SUMMARIZATION_URL + self.cred.SUMMARIZATION_PORT 


        ########################## REST ######################
        self.LANGUAGE_ENDPOINT = self.ENDPOINT
...
################################################################################################################################################
    ...
    def abstractive_summarisation_helper(self, call):
        ...
        headers = {
                    ...
                    "Ocp-Apim-Subscription-Key": self.key #  remove in case of containers
                }
